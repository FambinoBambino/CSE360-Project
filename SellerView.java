...
public class SellerView extends Windows
{
    ...
    private void displayListABookForm()
    {
        ...
        listBookButton.setOnAction(event ->
        {
            try
            {
                if (nameField.getText().strip().isEmpty() || authorField.getText().strip().isEmpty() || categoryField.getText().strip().isEmpty() || priceField.getText().strip().isEmpty() || finalPriceValue.getText().strip().isEmpty())
                ...
                } else
                {
                    ...
                    Book newBook = new Book(name, author, finalPrice, null, category, condition, "https://m.media-amazon.com/images/I/71fL+SKczgL.jpg");
        ...
        formLayout.addRow(5, authorLabel, authorField);
        formLayout.add(calculatePriceButton, 1, 6);
        formLayout.add(listBookButton, 1, 7);
