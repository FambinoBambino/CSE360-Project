...
public class AdminView extends Windows {
		...
		public AdminView(Stage loginStage) 
		{
			...
			Label homePageLabel = new Label("Admin Home Page"); // label for displaying home page message.

		BackgroundFill backgroundFill = new BackgroundFill(
		Color.rgb(140,29,64), //maroon?
		new CornerRadii(0, 2, 2, 0, true), // CornerRadii: (top-left, top-right, bottom-right, bottom-left)
		Insets.EMPTY
		);
			

		Button transactionButton = new Button("Transaction");
        transactionButton.setPadding(new Insets(20, 30, 20, 30)); // Padding: top, right, bottom, left
        ...
        statsButton.setPadding(new Insets(20, 30, 20, 30)); // Padding: top, right, bottom, left
        ...
        manageButton.setPadding(new Insets(20, 30, 20, 30)); // Padding: top, right, bottom, left
        ...
        logoutButton.setPadding(new Insets(20, 30, 20, 30)); // Padding: top, right, bottom, left
