...
public class Windows
	{
	    private Rectangle2D windowBounds = Screen.getPrimary().getBounds();//extracts the system's width and height
	    ...
	    private boolean isVisible = false;
			...
			{//since we are using gridpane, this method add an object to grid pane with coordinates
	    		pane.add(node, x, y);
	    	}
		...
		{//change size of image
	    	BackgroundSize newSize = new BackgroundSize(
	    			width,
	    			height,
	    			false,
	    			false,
